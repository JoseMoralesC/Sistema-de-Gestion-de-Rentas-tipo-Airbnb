...
{
    public partial class PuntarenasForm : Form
    {
        ...
        public PuntarenasForm(int provinciaId)
        {
        ...
        private void InicializarControles()
        {
            ...
            lblBienvenida.Text = "Bienvenido a Puntarenas";
            ...
            lblMensaje.Text = "¡Descubre todo lo que Puntarenas tiene para ofrecer! Elige tu alojamiento ideal";
        ...
        {
            string carpetaHospedajes = Path.Combine(Application.StartupPath, "Resources", "Puntarenas");
