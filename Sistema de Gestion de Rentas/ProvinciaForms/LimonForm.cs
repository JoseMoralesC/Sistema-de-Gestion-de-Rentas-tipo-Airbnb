...
{
    public partial class LimonForm : Form
    {
        ...
        public LimonForm(int provinciaId)
        {
        ...
        private void InicializarControles()
        {
            ...
            lblBienvenida.Text = "Bienvenido a Limon";
            ...
            lblMensaje.Text = "¡Descubre todo lo que Limon tiene para ofrecer! Elige tu alojamiento ideal";
        ...
        {
            var idsHospedajes = new List<int> { 25, 26, 27, 28 };
            var hospedajes = HospedajeLogic.ObtenerHospedajesParaContenedores("Limon", idsHospedajes);
        ...
        {
            string carpetaHospedajes = Path.Combine(Application.StartupPath, "Resources", "Limon");
