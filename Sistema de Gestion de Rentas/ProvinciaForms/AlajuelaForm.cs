...
{
    public partial class AlajuelaForm : Form
    {
        ...
        public AlajuelaForm(int provinciaId)
        {
        ...
        private void InicializarControles()
        {
            ...
            lblBienvenida.Text = "Bienvenido a Alajuela";
            ...
            lblMensaje.Text = "¡Descubre todo lo que Alajuela tiene para ofrecer! Elige tu alojamiento ideal";
        ...
        {
            var idsHospedajes = new List<int> { 13, 14, 15, 16 };
            var hospedajes = HospedajeLogic.ObtenerHospedajesParaContenedores("Alajuela", idsHospedajes);
        ...
        {
            string carpetaHospedajes = Path.Combine(Application.StartupPath, "Resources", "Alajuela");
