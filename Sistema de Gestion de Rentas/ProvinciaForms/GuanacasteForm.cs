...
{
    public partial class GuanacasteForm : Form
    {
        ...
        public GuanacasteForm(int provinciaId)
        {
        ...
        private void InicializarControles()
        {
            ...
            lblBienvenida.Text = "Bienvenido a Guanacaste";
            ...
            EstilosPanelHuesped.EstiloBanner(
                banner,
                Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "banner.jpg"),
                200,
            ...
            lblMensaje.Text = "¡Descubre todo lo que Guanacaste tiene para ofrecer! Elige tu alojamiento ideal";
        ...
        {
            var idsHospedajes = new List<int> { 21, 22, 23, 24 };
            var hospedajes = HospedajeLogic.ObtenerHospedajesParaContenedores("Guanacaste", idsHospedajes);
        ...
        {
            string carpetaHospedajes = Path.Combine(Application.StartupPath, "Resources", "Guanacaste");
