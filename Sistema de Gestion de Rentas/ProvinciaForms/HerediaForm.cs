...
{
    public partial class HerediaForm : Form
    {
        ...
        public HerediaForm(int provinciaId)
        {
        ...
        private void InicializarControles()
        {
            ...
            lblBienvenida.Text = "Bienvenido a Heredia";
            ...
            lblMensaje.Text = "¡Descubre todo lo que Heredia tiene para ofrecer! Elige tu alojamiento ideal";
        ...
        {
            var idsHospedajes = new List<int> { 17, 18, 19, 20 };
            var hospedajes = HospedajeLogic.ObtenerHospedajesParaContenedores("Heredia", idsHospedajes);
        ...
        {
            string carpetaHospedajes = Path.Combine(Application.StartupPath, "Resources", "Heredia");
